...
import com.rifeng.agriculturalstation.wheelview.OnWheelChangedListener;
import com.rifeng.agriculturalstation.wheelview.OnWheelScrollListener;
import com.rifeng.agriculturalstation.wheelview.WheelView;
import com.rifeng.agriculturalstation.wheelview.adapter.AbstractWheelTextAdapter1;
...
//	private WheelView wvArea;
	...
	public ChangeAddressPopwindow(final Context context, String province, String city, String area) {
		super(context);
...
//			dismiss();
	...
	private void initJsonData() {
		try {
			...
			is.close();
			System.out.println("city.json --- " + sb.toString());
	 ...
	 * 根据城市，生成该城市的所有地区
	 *
	 * 上海、北京、天津、重庆直辖市，香港、澳门特别行政区会走else中的语句
	 *
	 * @param areas
	 */
